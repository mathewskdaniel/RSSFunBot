...
logger = log.getLogger('RSSFunBot.db')
...
class __EffectiveOptions:
    ...
    def __init__(self):
        ...
        self.__default_options: dict[str, Union[str, int]] = {
            ...
            "reddit_video_download": int(env.REDDIT_VIDEO_DOWNLOAD),
            "reddit_video_max_height": env.REDDIT_VIDEO_MAX_HEIGHT,
            "reddit_video_max_bytes": env.REDDIT_VIDEO_MAX_BYTES,
            "reddit_video_download_timeout": env.REDDIT_VIDEO_DOWNLOAD_TIMEOUT,
